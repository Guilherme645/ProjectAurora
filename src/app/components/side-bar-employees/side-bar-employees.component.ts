...
@Component({
  selector: 'app-side-bar-employees',
  templateUrl: './side-bar-employees.component.html',
  styleUrls: ['./side-bar-employees.component.css'],
  standalone: false
})
export class SideBarEmployeesComponent implements OnInit {
